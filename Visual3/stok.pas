...
if(zqry1.Locate('nama_poin',edt1.Text,[]))then
begin
...
begin
zqry1.sql.clear;
zqry1.sql.Add('insert into tabel_poin values(null,"'+edt1.Text+'","'+edt2.Text+'","'+cmb1.Text+'","'+cmb2.Text+'")');
zqry1.ExecSQL;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update tabel_poin set nama_poin= "'+edt1.Text+'",bobot="'+edt2.Text+'", jenis= "'+cmb1.Text+'",status= "'+cmb2.Text+'" where id_poin ="'+id+'"');
zqry1.ExecSQL;
