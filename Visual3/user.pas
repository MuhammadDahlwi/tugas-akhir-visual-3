...
if(zqry1.Locate('nama',Edit1.Text,[]))and(zqry1.Locate('password',Edit2.Text,[]))then
begin
...
begin
zqry1.sql.clear;
zqry1.sql.Add('insert into user values(null,"'+edit1.Text+'","'+edit2.Text+'","'+edit3.Text+'","'+edit4.Text+'","'+edit5.Text+'","'+edt1.Text+'","'+ComboBox1.Text+'","'+edt2.Text+'","'+ComboBox2.Text+'")');
zqry1.ExecSQL;
